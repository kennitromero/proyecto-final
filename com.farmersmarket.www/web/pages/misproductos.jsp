                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a class="a" href="misproductos.jsp">Mis Productos</a></li>
                            <li class="active"><a class="a" href="misproductos.jsp">Productos Asociados</a></li>
                        </ol>
                    </div>                    
                    <!-- Fin de miga de pan -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="well-sm">
                                    <h4 class="text-center">Lista de mis productos asociados</h4>
                                </div>
                                <br>
                                <%
                            ...
                            %>
                            <div class="col-md-3">
                                <img class="thumbnail" src="../img/publicidad/no-encuentra-producto.jpg" alt="Publicidad">
                            </div>
                        </div>                        
                    </div>
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                <div class="panel-body">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="opDetalle" value="0" class="form-control" aria-label="Amount (to the nearest dollar)">
                                                        <span class="input-group-addon">.%</span>
                                                    </div>
                                                    <br>
