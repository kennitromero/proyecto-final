                        ...
                        <div class="row">
                            <div class="col-md-12" >
                                <form method="GET" action="../GestionProductos" id="formAsociarProductos">                                    
                                    <legend class="text-center">Seleccione los productos a ofertar <small><span class="text-info">Tiene disponibles: <%= faOfer.mostrarCuposDisponiblesAsociar(actualUsuario.getIdUsuario()) %> cupo(s)</span></small></legend>                                    
